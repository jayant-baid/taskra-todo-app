    ...
    <div className="h-full overflow-y-auto bg-[#14161A] text-[#E4E6EB] px-4 py-12">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex flex-col gap-8 text-sm leading-relaxed text-[#C8CDD8]">
          ...
          <section>
            <p>
              Taskra (&ldquo;we&rdquo;, &ldquo;our&rdquo;, or &ldquo;the
              app&rdquo;) is a personal task management application. This
          ...
          <section>
            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                <p>
                  When you create an account, we collect your chosen username
                  and a securely hashed password. If you sign in with Google or
                  Facebook, we receive your name, email address, and profile
                  picture URL from that provider.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-[#E4E6EB] mb-1">Task Data</h3>
                <p>
                  We store the tasks, recurring schedules, and completion
                  records that you create within the app. This data is
                  associated with your account to enable cross-device sync.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-[#E4E6EB] mb-1">
                ...
                <p>
                  We issue a session token stored as a secure HTTP-only cookie
                  to keep you signed in. Sessions expire after 30 days.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside flex flex-col gap-2 text-[#C8CDD8]">
              ...
              <li>
                We do <strong className="text-[#E4E6EB]">not</strong> sell,
          ...
          <section>
            ...
            <p>
              ...
              redirected to that provider&apos;s authorization screen. We only
              request the minimum necessary scopes:
            </p>
            <ul className="list-disc list-inside mt-3 flex flex-col gap-1">
              <li>
                <strong className="text-[#E4E6EB]">Google:</strong> openid,
                email, profile
              </li>
              <li>
            ...
            <p className="mt-3">
              ...
              your social account to your Taskra account. We do not post on your
              behalf or access your contacts or friends lists.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              associated data at any time by contacting us (see Section 8). We
          ...
          <section>
            ...
            <p>
              Taskra is not directed at children under the age of 13. We do not
          ...
          <section>
            ...
            <p>
              ...
              the most recent revision. Continued use of the app after changes
